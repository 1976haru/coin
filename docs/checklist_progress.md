...
마지막 업데이트: 2026-05-17 (#15 Market Data Collector 구현 — OHLCV/funding/FX 추가, Watchlist 기반 collect_all + MARKET_COLLECTOR_MAX_SYMBOLS + DB 영속화(coin_candle/coin_tick/coin_orderbook_snapshot) + /api/market/collector/status + Market 페이지. backend 1471 passed / 1 skipped, frontend typecheck/build/test 통과. 16번 이후 미수정.)

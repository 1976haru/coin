...
마지막 업데이트: 2026-05-17 (#16 Data Freshness 구현 — FreshnessTracker + Policy + Reconnect scope + collect_all/collect 연동 + order_preview 가드 + REST /api/freshness + frontend Freshness 패널. backend 1512 passed / 1 skipped, frontend typecheck/build/test 통과. 17번 이후 미수정.)

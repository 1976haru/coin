...
마지막 업데이트: 2026-05-17 (#17 Data Quality 구현 — historical candle layer (data_quality.py) + 6검사 + GOOD/WARNING/EXCLUDE day grade + BacktestPromotionGuard + CLI historical 모드 + GET /api/market/data-quality/summary + docs/data_quality.md. backend 1556 passed / 1 skipped, frontend 변경 없음. 18번 이후 미수정.)
